                ...
                <form action="" method="post">
                    <div class="panel rounded shadow">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h3 class="panel-title text-special">User Generator</h3>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            A dating website without users is not a dating website. <br> This tool will generate up to 50 unique users, to give your website a solid start. <br>
                            <br>
                            ...
                            <br><br>
                            <input type="submit" name="generate" class="btn btn-theme" value="Generate">
                        </div>
                    </div>
                </div>
